...
license: CC-BY-4.0
description: >
  Next Gen Spec-Driven Development (ng-sdd) v2.1. Framework enterprise de Spec-Driven
...
# 📐 ng-sdd v2.1 — Next Gen Spec-Driven Development
...
| `/ngsdd:research` | `phases/01-research.md`                               |
...
| `/ngsdd:execute`  | `phases/05-execute.md` + `workflows/gitflow.md`       |
